...
//{
//    public class DotnetIsolatedEventhubAppTest : BaseE2E, IClassFixture<KafkaE2EFixture>
//    {
//        private KafkaE2EFixture kafkaE2EFixture;
//        ITestOutputHelper output;

//        public DotnetIsolatedEventhubAppTest(KafkaE2EFixture kafkaE2EFixture, ITestOutputHelper output) : base(kafkaE2EFixture, Language.DOTNETISOLATED, BrokerType.EVENTHUB, output)
//        {
...
//        [Fact]
//        public async Task DotnetIsolated_App_Test_Single_Event_Eventhub()
//        {
//            string reqMsg = "Single-Event";
//            string url = "http://localhost:" + Constants.DOTNETWORKERAPP_EVENTHUB_PORT + "/api/" + Constants.DOTNETWORKER_SINGLE_APP_NAME;
...
//        [Fact]
//        public async Task DotnetIsolated_App_Test_Multi_Event_Eventhub()
//        {
//            string reqMsg1 = "Multi-Event1";
//            string reqMsg2 = "Multi-Event2";
//            string reqMsg3 = "Multi-Event3";

//            string url = "http://localhost:" + Constants.DOTNETWORKERAPP_EVENTHUB_PORT + "/api/" + Constants.DOTNETWORKER_MULTI_APP_NAME;
