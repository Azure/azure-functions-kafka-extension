...
{
    public class TSConfluentAppTest : BaseE2E, IClassFixture<KafkaE2EFixture>
    {
        private KafkaE2EFixture kafkaE2EFixture;
        ITestOutputHelper output;

        public TSConfluentAppTest(KafkaE2EFixture kafkaE2EFixture, ITestOutputHelper output) : base(kafkaE2EFixture, Language.TYPESCRIPT, BrokerType.CONFLUENT, output)
        {
        ...
        [Fact]
        public async Task TS_App_Test_Single_Event_Confluent()
        {
            string reqMsg = "Single-Event";
            string url = "http://localhost:" + Constants.TSAPP_CONFLUENT_PORT + "/api/" + Constants.TS_SINGLE_APP_NAME;
        ...
        [Fact]
        public async Task TS_App_Test_Multi_Event_Confluent()
        {
            string reqMsg1 = "Multi-Event1";
            string reqMsg2 = "Multi-Event2";
            string reqMsg3 = "Multi-Event3";

            string url = "http://localhost:" + Constants.TSAPP_CONFLUENT_PORT + "/api/" + Constants.TS_MULTI_APP_NAME;
