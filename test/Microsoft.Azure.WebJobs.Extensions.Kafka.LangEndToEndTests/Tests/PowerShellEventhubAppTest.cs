...
{
    public class PowerShellEventhubAppTest : BaseE2E, IClassFixture<KafkaE2EFixture>
    {
        private KafkaE2EFixture kafkaE2EFixture;
        ITestOutputHelper output;

        public PowerShellEventhubAppTest(KafkaE2EFixture kafkaE2EFixture, ITestOutputHelper output) : base(kafkaE2EFixture, Language.POWERSHELL, BrokerType.EVENTHUB, output)
        {
        ...
        [Fact]
        public async Task PowerShell_App_Test_Single_Event_Eventhub()
        {
            string reqMsg = "Single-Event";
            string url = "http://localhost:" + Constants.PWSHELL_EVENTHUB_PORT + "/api/" + Constants.PWSHELL_SINGLE_APP_NAME;
        ...
        [Fact]
        public async Task Powershell_App_Test_Multi_Event_Eventhub()
        {
            string reqMsg1 = "Multi-Event1";
            string reqMsg2 = "Multi-Event2";
            string reqMsg3 = "Multi-Event3";

            string url = "http://localhost:" + Constants.PWSHELL_EVENTHUB_PORT + "/api/" + Constants.PWSHELL_MULTI_APP_NAME;
