...
{
    public class PowerShellConfluentAppTest : BaseE2E, IClassFixture<KafkaE2EFixture>
    {
        private KafkaE2EFixture kafkaE2EFixture;
        ITestOutputHelper output;

        public PowerShellConfluentAppTest(KafkaE2EFixture kafkaE2EFixture, ITestOutputHelper output) : base(kafkaE2EFixture, Language.POWERSHELL, BrokerType.CONFLUENT, output)
        {
        ...
        public async Task Java_App_Test_Multi_Event_Confluent()
        {
            ...
            string url = "http://localhost:" + Constants.PWSHELL_CONFLUENT_PORT + "/api/" + Constants.PWSHELL_MULTI_APP_NAME;
