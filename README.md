...
If you received an error message that the Kafka broker is down, edit the `hosts` file located in `C:\Windows\System32\drivers\etc\hosts` with elevated privileges with the example below:
